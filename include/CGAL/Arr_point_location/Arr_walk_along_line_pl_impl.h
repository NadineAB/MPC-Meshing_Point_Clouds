...
//
// $URL: svn+ssh://scm.gforge.inria.fr/svn/cgal/branches/releases/CGAL-4.1-branch/Arrangement_on_surface_2/include/CGAL/Arr_point_location/Arr_walk_along_line_pl_impl.h $
// $Id: Arr_walk_along_line_pl_impl.h 67117 2012-01-13 18:14:48Z lrineau $
// 
//
        ...
        ! is_vertical (curr->curve()))
    {
      ...
      if (source_res != EQUAL)
      {
        ...
        if (target_res == EQUAL)
        {
          ...
          //          (a)                        (b)
          //
          target_res = top_traits->compare_x (p,
                                              &(*(next_non_vert->target())));
