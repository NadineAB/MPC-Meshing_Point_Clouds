...
//
// $URL: svn+ssh://scm.gforge.inria.fr/svn/cgal/branches/releases/CGAL-4.1-branch/Kinetic_data_structures/include/CGAL/Polynomial/internal/Rational/Euclidean_Sturm_sequence.h $
// $Id: Euclidean_Sturm_sequence.h 67093 2012-01-13 11:22:39Z lrineau $
// 
//
// Author(s)     : Daniel Russel <drussel@alumni.princeton.edu>

#ifndef CGAL_POLYNOMIAL_INTERNAL_EUCLIDEAN_STURM_SEQUENCE_H
#define CGAL_POLYNOMIAL_INTERNAL_EUCLIDEAN_STURM_SEQUENCE_H
...
/*!
  \file Euclidean_Sturm_sequence.h A non-filtered Sturm sequence class
...
// IN GENERAL I HAVE TO CONSIDER ALL THE LIMITING CASES
            ...
            while ( true ) {
                r = -this->k_.pseudo_remainder_object()(this->seq_[this->size_-2],
...
// COMPUTED
    ...
    public:
        Euclidean_Sturm_sequence() : Base() {}

        Euclidean_Sturm_sequence(const Polynomial& p, const Polynomial& q,
            const Kernel &k)
        : Base(p, q, k) {
