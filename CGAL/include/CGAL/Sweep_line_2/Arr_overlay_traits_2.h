...
//
// $URL: svn+ssh://scm.gforge.inria.fr/svn/cgal/branches/releases/CGAL-4.1-branch/Arrangement_on_surface_2/include/CGAL/Sweep_line_2/Arr_overlay_traits_2.h $
// $Id: Arr_overlay_traits_2.h 67117 2012-01-13 18:14:48Z lrineau $
// 
//
...
public:
  ...
  public:
                               ...
                               OutputIterator oi)
    {
      ...
      Parameter_space_in_x_2      ps_x_op =
        m_traits->parameter_space_in_x_2_object();
      Parameter_space_in_y_2      ps_y_op =
      ...
      for (; oi != oi_end; ++oi)
      {
        ...
        if (base_ipt != NULL)
        {
          ...
          if (xcv1.color() == RED)
          {
            ...
            blue_obj = CGAL::make_object (xcv2.blue_halfedge_handle());
          }
          else
          {
            CGAL_assertion(xcv2.color() == RED &&
                           xcv1.color() == BLUE);
            red_obj = CGAL::make_object(xcv2.red_halfedge_handle());
            blue_obj = CGAL::make_object(xcv1.blue_halfedge_handle());
          }
  ...
  public:
    Comparison_result operator() (const Point_2 & pt1,
                                  const Point_2 & pt2) const
    {
