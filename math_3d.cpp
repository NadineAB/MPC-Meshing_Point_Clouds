...
Vector3f Vector3f::Cross(const Vector3f& v) const
{
 ...
 bool Vector3f ::Equal( const Vector3f &v,const Vector3f &v1 )
{
...
float Vector3f ::Distance( const Vector3f &V1 )
{
...
Vector3f Vector3f::Normalize(double area)
{
double larea = sqrt( area*area);
		x/= larea;
		y/= larea;
		z/= larea;
return Vector3f(x,y,z);
